        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return user.save().then(function (data) {
              ...
              //     user:data
              // });
              res.cookie("message", "User created successfully!!", {
                httpOnly: true
              });
              res.redirect("/user");
            })["catch"](function (err) {
          ...
          case 0:
            ...
            return _user["default"].findByIdAndUpdate(id, req.body, {
              ...
              if (!data) {
                ...
                res.cookie("message", "User updated successfully!!", {
                  httpOnly: true
                });
                res.redirect("/user");
              }
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _user["default"].findByIdAndRemove(req.params.id).then(function (data) {
              if (!data) {
                res.status(404).send({
                  message: "User not found."
                });
                ...
                //   });
                res.cookie("message", "User deleted successfully!!", {
                  httpOnly: true
                });
                res.redirect("/user");
              }
